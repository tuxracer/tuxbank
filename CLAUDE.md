...
- **`src/hooks/`** — `useIsCompact` (matchMedia; true below 640px, switches the calendar to compact rendering) and `useSwipeNavigation` (swipe the grid to change months in compact mode).
