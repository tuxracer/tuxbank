...
- **Recurring scope dialog:** This event / This and following / All events (used for edit, delete, and move); options that cannot apply are hidden, so the last occurrence of a series offers no "This and following" (see §7).
